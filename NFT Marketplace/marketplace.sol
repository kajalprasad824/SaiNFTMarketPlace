...
interface DataStructure {
    ...
    // function storeData(uint256 _tokenId) external returns(NFTData memory);
}

interface IERC721Upgradeable is IERC165Upgradeable, DataStructure {
    /**
    ...
    function directMint(
        ...
        string memory _json,
        uint256 _royaltyCut,
        address _royaltyWalletAddr
    ) external;

    function getPlatformFeeDetails()
        external
        view
        returns (address PlatformWalletAddr, uint256 PlatformCuts);
